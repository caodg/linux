...
set my2tics default
set mcbtics default
set xtics border mirror norotate  ("Windows" 9.00000, "VMS" 8.00000, "Unix" 7.00000, "Solaris" 6.00000, "MacOS/X" 5.00000, "OpenBSD" 4.00000, "NetBSD" 3.00000, "FreeBSD" 2.00000, "Linux" 1.00000)
...
set xrange [ 0.000000 : 10.0000 ] noreverse nowriteback
...
plot "sucks_rocks.txt" using ($1-0.15):3 title "Sucks" with boxes fill solid, "sucks_rocks.txt" using ($1+0.15):4 title "Rocks" with boxes fill solid
#    EOF
